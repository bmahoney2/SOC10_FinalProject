...
```
# Odds Ratio Table
Lastly, we created a table listing the odds ratio, 95% confidence interval, and p-value for each coefficient in the logistic regression. Since logistic regression computes the log odds of having diabetes, the "exponentiate = TRUE" function converts log odds to an odds ratio (using the Sigmoid function), which allows for greater interpretability. 
